...
class Register extends Component {
    ...
    render() {
        const { RegisterStore: { nickName, userAcc, msgVc, msgLeftTime, getMsgVc, userPwd, setData } } = this.props;
        return (
            <Container>
                <Header title="注册" />
                <Content>
                    <View style={styles.registerWrapper}>
                        <View style={mb(25)}>
                            <Text style={[fz(28), mb(15)]}>用户名</Text>
                            <Item regular>
                                <Input onChangeText={val => setData('nickName', val)} value={nickName} placeholder="请输入您的用户名" />
                            </Item>
                        </View>
                        <View style={mb(25)}>
